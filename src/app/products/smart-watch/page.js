...
const Page = () => {
    ...
    const filteredproducts = products.filter(product => product.category[0].category === 'Smart Watch');
    return (
        <div>
            <h1 className='my-2'> <svg className="gradient-text text-3xl font-bold" width="100%" height="38" xmlns="http://www.w3.org/2000/svg">
                ...
                <text x="50%" y="30" fill="url(#gradient)" textAnchor="middle">Smart Watch</text>
            </svg></h1>
            {
